  ...
  if (items.length === 0) {
    return (
      <div className="mx-auto max-w-2xl px-4 py-24 text-center">
        ...
        <Link
          to="/retail"
          className="mt-8 inline-flex items-center gap-2 px-6 py-3 rounded-md bg-gradient-gold text-primary-foreground font-semibold"
        >
          Shop Retail <ArrowRight className="h-4 w-4" />
        </Link>
      </div>
    );
  }
    ...
    <div className="mx-auto max-w-5xl px-4 md:px-8 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-8">
        ...
        <aside className="self-start rounded-xl border border-border bg-card p-6 sticky top-24">
          ...
          <Link
            to="/checkout"
            className="mt-6 inline-flex items-center justify-center gap-2 w-full px-5 py-3 rounded-md bg-gradient-gold text-primary-foreground font-semibold"
          >
